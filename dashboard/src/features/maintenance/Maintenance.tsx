  ...
  return (
    <div className="space-y-6">
      ...
      <div className="tabs tabs-boxed border border-zinc-800/60 bg-zinc-950/60 p-1 flex flex-wrap gap-1">
        ...
        <button
          className={`tab tab-sm sm:tab-md transition-all duration-200 flex items-center gap-2 ${
            activeTab === "llm-costs" ? "tab-active bg-indigo-600/90 text-white font-bold" : "text-zinc-400 hover:text-zinc-200"
          }`}
          onClick={() => setActiveTab("llm-costs")}
          type="button"
        >
        ...
        <button
          className={`tab tab-sm sm:tab-md transition-all duration-200 flex items-center gap-2 ${
            activeTab === "pipeline-metrics" ? "tab-active bg-indigo-600/90 text-white font-bold" : "text-zinc-400 hover:text-zinc-200"
          }`}
